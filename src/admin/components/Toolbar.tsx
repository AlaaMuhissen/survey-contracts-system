      ...
      >
        ...
        <div className="md:col-span-2">
          ...
          <select
            ...
            onChange={(e) => {
              console.log(`selected project: ${e.target.value}  filters before set: ${JSON.stringify(filters)}`);
        ...
        <div className="md:col-span-4 flex flex-wrap gap-2">
          <button
            className="rounded-lg border px-3 py-2 bg-red-600 text-white border-red-600"
            onClick={() =>
              set({
